...
export default function NewCampaignPage() {
    ...
    const handleSave = async () => {
        ...
        setSaving(true)
        try {
            await axios.post('/api/campaigns', { name, messages })
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Design your 7-day nurturing sequence</p>
                    </div>
                </div>
                                    ...
                                    <div className="grid md:grid-cols-[1fr,300px] gap-6">
                                        <div className="space-y-4">
                                            <div className="space-y-2">
                                                ...
                                                <Textarea
                                                    placeholder="Type your WhatsApp message here. Use {{1}}, {{2}} for variables if configured in AI Sensy template."
